export const storeCustomization = {
  ...
  home: {
    ...
    quick_delivery_description: {
      en: "There are many products you will find in our shop, Choose your daily necessary product from our Rasa Store shop and get some special offers. See Our latest discounted products from here and get a special discount.",
      de: "Es gibt viele Produkte, die Sie in unserem Shop finden. Wählen Sie Ihr täglich benötigtes Produkt aus unserem Rasa Store-Shop und erhalten Sie einige Sonderangebote. Sehen Sie sich hier unsere neuesten reduzierten Produkte an und sichern Sie sich einen Sonderrabatt.",
    },
    ...
    daily_need_title: {
      en: "Get Your Daily Needs From Our Rasa Store Store",
      de: "Holen Sie sich Ihren täglichen Bedarf in Ihrem CloudCleaver-Shop",
    },
    daily_need_description: {
      en: "There are many products you will find in our shop, Choose your daily necessary product from our Rasa Store shop and get some special offers.",
      de: "Es gibt viele Produkte, die Sie in unserem Shop finden. Wählen Sie Ihr täglich benötigtes Produkt aus unserem Rasa Store-Shop und erhalten Sie einige Sonderangebote.",
    },
  ...
  about_us: {
    ...
    top_title: {
      en: "Welcome to our Rasa Store shop",
      de: "Willkommen in unserem Rasa Store-Shop",
    },
    top_description: {
  ...
  contact_us: {
    ...
    email_box_email: {
      en: "info@Rasa Store.com ",
      de: "info@Rasa Store.com",
    },
    email_box_text: {
  ...
  seo: {
    ...
    meta_description: "Premium Sneakers & Streetwear e-commerce Template",
    meta_img:
      "https://res.cloudinary.com/ahossain/image/upload/v1636729752/facebook-page_j7alju.png",
    meta_keywords: "e-commerce, online store",
    meta_title:
      "RASA - Premium Sneakers & Streetwear Store",
    meta_url: "https://Rasa Store-store-nine.vercel.app/",
  },
  theme: {
    color: "green",
  }
