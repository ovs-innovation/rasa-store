...
const resolveImageUrl = (url) => {
  ...
  if (lower.includes("res.cloudinary.com/dhqcwkpzp/") || lower.includes("res.cloudinary.com/ahossain/")) {
    return null;
  }
  return trimmed;
};
      ...
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.table}>
          ...
          {data?.cart?.map((item, index) => {
            const productImg = absUrl(resolveImageUrl(item.image) || "/rasaLogo.png");
            return (
