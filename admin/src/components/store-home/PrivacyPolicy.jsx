        ...
        <div className="xl:px-10 flex-grow scrollbar-hide w-full max-h-full">
          ...
          <div className="grid md:grid-cols-5 sm:grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 md:mb-6 mb-3">
            ...
            <div className="sm:col-span-4">
              <SwitchToggle
                title=""
                handleProcess={setShippingDeliveryPolicy}
                processOption={shippingDeliveryPolicy}
          ...
          <div
            style={{
              height: shippingDeliveryPolicy ? "auto" : 0,
              transition: "all 0.5s",
              visibility: !shippingDeliveryPolicy ? "hidden" : "visible",
              opacity: !shippingDeliveryPolicy ? "0" : "1",
            }}
          >
            <div className="grid md:grid-cols-5 sm:grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 md:mb-6 mb-3">
              <label className="block md:text-sm md:col-span-1 sm:col-span-2 text-xs font-semibold text-gray-600 dark:text-gray-400 md:mb-1">
              ...
              <div className="sm:col-span-4">
                <Uploader
                  imageUrl={shippingDeliveryPolicyHeaderBg}
                  setImageUrl={setShippingDeliveryPolicyHeaderBg}
                  targetWidth={1920}
                  targetHeight={373}
                />
              </div>
            ...
            <div className="grid md:grid-cols-5 sm:grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 md:mb-6 mb-3">
              ...
              <div className="sm:col-span-4">
                <InputAreaTwo
                  register={register}
                  label="Page Title"
                  name="shipping_delivery_page_title"
                  type="text"
                  placeholder={t("PageTitle")}
                />
                <Error errorName={errors.shipping_delivery_page_title} />
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-5 sm:grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 md:mb-6 mb-3">
              ...
              <div className="sm:col-span-4">
                <Editor
                  editorState={
                    shippingDeliveryPolicyTextEdit ? shippingDeliveryPolicyTextEdit : null
                  }
                  wrapperClassName="demo-wrapper"
                  editorClassName="demo-editor"
                  onEditorStateChange={setShippingDeliveryPolicyTextEdit}
                  editorStyle={{
                    border: "1px solid #F1F1F1",
                    padding: "0 15px",
                  }}
