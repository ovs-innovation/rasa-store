        ...
        <CardBody className="flex justify-between">
          <div className="">
            <Button
              ...
              className="w-full rounded-md h-10 flex items-center justify-center bg-store-500 text-white px-1 hover:bg-store-700"
            >
              <span className="mr-2">
                <FiMail />
              </span>
                          ...
                          <TableRow className="border-none" key={index + 1}>
                            ...
                            >
                              ...
                              >
                                ...
                                {value.status === "unread" && (
                                  <span className="px-2 md:flex hidden focus:outline-none text-store-600">
                                    <img
                                      src={ellipse}
                                      width={12}
                                      height={12}
