...
const useStoreHomeSubmit = () => {
  ...
  const [promotionalBannerImage1, setPromotionalBannerImage1] = useState("");
  const [promotionalBannerImage2, setPromotionalBannerImage2] = useState("");
  const [promotionalBannerImage3, setPromotionalBannerImage3] = useState("");
    ...
    const getStoreCustomizationData = async () => {
      try {
        ...
        if (res) {
          ...
          setPromotionalBannerImage1(res?.home?.promotional_banner_image1 || "");
          setPromotionalBannerImage2(res?.home?.promotional_banner_image2 || "");
          setPromotionalBannerImage3(res?.home?.promotional_banner_image3 || "");
