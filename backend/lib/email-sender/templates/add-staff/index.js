...
>
 ...
 <h2>Hello ${option.name}</h2>
    ...
    option.cname
      ...
      <p style="margin-top: 35px;">If you did not initiate this request, please contact us immediately at ${option.contact_email}</p>

     <p style="margin:0px auto; margin-top:40px; text-align:center;">Thank you   <h4 style="margin:1px; margin-bottom:0px; text-align:center;">${option.shop_name} Team</h4></p>
