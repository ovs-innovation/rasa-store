const setting = [
  {
    setting: {
      ...
      receipt_size: "57-mm",
      from_email: "info.farmacykart@gmail.com",
    ...
    setting: {
      ...
      home: {
        ...
        quick_delivery_description: {
          en: "There are many products you will find in our shop, Choose your daily necessary product from our Farmacykart shop and get some special offers. See Our latest discounted products from here and get a special discount.",
          de: "Es gibt viele Produkte, die Sie in unserem Shop finden. Wählen Sie Ihr täglich benötigtes Produkt aus unserem Farmacykart-Shop und erhalten Sie einige Sonderangebote. Sehen Sie sich hier unsere neuesten reduzierten Produkte an und sichern Sie sich einen Sonderrabatt.",
        },
        ...
        daily_need_title: {
          en: "Get Your Daily Needs From Our Farmacykart Store",
          de: "Holen Sie sich Ihren täglichen Bedarf in Ihrem CloudCleaver-Shop",
        },
        daily_need_description: {
          en: "There are many products you will find in our shop, Choose your daily necessary product from our Farmacykart shop and get some special offers.",
          de: "Es gibt viele Produkte, die Sie in unserem Shop finden. Wählen Sie Ihr täglich benötigtes Produkt aus unserem Farmacykart-Shop und erhalten Sie einige Sonderangebote.",
        },
      ...
      about_us: {
        ...
        top_title: {
          en: "Welcome to our Farmacykart shop",
          de: "Willkommen in unserem Farmacykart-Shop",
        },
        top_description: {
      ...
      contact_us: {
        ...
        email_box_email: {
          en: "info@Farmacykart.com ",
          de: "info@Farmacykart.com",
        },
        email_box_text: {
      ...
      shipping_delivery_policy: {
        ...
        title: {
          ...
          de: "Versand- und Lieferrichtlinie",
        },
        description: {
          en: "<h1><strong>Shipping & Delivery Policy</strong></h1>\n<p>At Farmacykart, we are committed to delivering your orders quickly and safely. This Shipping & Delivery Policy outlines our shipping procedures and delivery timelines.</p>\n<h2><strong>Shipping Methods</strong></h2>\n<p>We offer multiple shipping options to meet your delivery needs:</p>\n<ul>\n<li><strong>Standard Shipping:</strong> 5-7 business days</li>\n<li><strong>Express Shipping:</strong> 2-3 business days</li>\n<li><strong>Overnight Shipping:</strong> Next business day delivery</li>\n</ul>\n<h2><strong>Delivery Areas</strong></h2>\n<p>We currently ship to all major cities and regions. Delivery times may vary based on your location. Remote areas may require additional shipping time.</p>\n<h2><strong>Order Processing</strong></h2>\n<p>Orders are typically processed within 1-2 business days. You will receive a confirmation email with your order number and tracking information once your order has been shipped.</p>\n<h2><strong>Shipping Costs</strong></h2>\n<p>Shipping costs are calculated based on the weight of your order and your delivery location. Free shipping is available for orders above a certain threshold. Shipping costs will be displayed during checkout.</p>\n<h2><strong>Delivery Tracking</strong></h2>\n<p>Once your order is shipped, you will receive a tracking number via email. You can use this number to track your package's delivery status on our website or the courier's website.</p>\n<h2><strong>Delivery Issues</strong></h2>\n<p>If you experience any issues with delivery, such as damaged packages or delayed shipments, please contact our customer service team immediately. We will work to resolve the issue promptly.</p>\n<h2><strong>Contact Us</strong></h2>\n<p>If you have any questions about shipping or delivery, please contact us at [Your Contact Email/Phone].</p>",
        },
      },
      faq: {
        page_status: true,
        ...
        faq_one: {
          en: "How does the Farmacykart work?",
          de: "Wie funktioniert der Farmacykart?",
        },
        description_one: {
        ...
        faq_five: {
          en: "What is Farmacykart EC2 auto scaling?",
          de: "Was ist die automatische Skalierung von Farmacykart EC2?",
        },
        description_five: {
          en: "Continually impact seamless imperatives for best-of-breed best practices. Phosfluorescently facilitate parallel applications with unique imperatives. Proactively plagiarize functionalized deliverables via inexpensive solutions. Collaboratively embrace web-enabled infomediaries rather than diverse testing procedures.",
        ...
        faq_six: {
          en: "What are the benefits of using Farmacykart affliate?",
